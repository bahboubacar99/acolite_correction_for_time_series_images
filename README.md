# Automatic Processing of Sentinel-2 time series images level 1C with atmospheric correction model "ACOLITE"
...
```
``` bash
 git clone https://github.com/bahboubacar99/acolite_correction_for_time_series_images.git
```
